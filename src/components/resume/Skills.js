    ...
    >
      <div className="w-full lgl:w-1/2">
        <div className="py-12 font-titleFont flex flex-col gap-4">
          ...
          <h2 className="text-3xl md:text-3xl font-bold">Programming Skill</h2>
        </div>
        ...
        <div className="overflow-x-hidden">
          ...
          <div className="overflow-x-hidden">
            <p className="text-sm uppercase font-medium">C & 
                C++ Programming.</p>
            <span className="w-full h-2 bgOpacity rounded-md inline-flex mt-2">
              <motion.span
                initial={{ x: "-100%", opacity: 0 }}
      ...
      <div className="w-full lgl:w-1/2">
        <div className="py-12 font-titleFont flex flex-col gap-4">
          ...
          <h2 className="text-3xl md:text-3xl font-bold">Frontend</h2>
        </div>
      ...
      <div className="w-full lgl:w-1/2">
        <div className="py-12 font-titleFont flex flex-col gap-4">
          ...
          <h2 className="text-3xl md:text-3xl font-bold">Backend</h2>
        </div>
        <div className="flex flex-col gap-6">
        <div className="overflow-x-hidden">
      ...
      <div className="w-full lgl:w-1/2">
        <div className="py-12 font-titleFont flex flex-col gap-4">
          ...
          <h2 className="text-3xl md:text-3xl font-bold">Others</h2>
        </div>
        <div className="flex flex-col gap-6">
